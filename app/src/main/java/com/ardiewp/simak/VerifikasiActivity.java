...
public class VerifikasiActivity extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<Pengguna, VerifikasiViewHolder> mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Pengguna, VerifikasiViewHolder>(
                Pengguna.class,
                R.layout.list_verifikasi,
                VerifikasiViewHolder.class,
                mUserRef.orderByChild("level").equalTo("Guru")
        ) {
            @Override
            protected void populateViewHolder(VerifikasiViewHolder viewHolder, Pengguna model, int position) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.it_setting){
            Intent intent = new Intent(VerifikasiActivity.this, SettingActivity.class);
