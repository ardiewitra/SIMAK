...
public class GuruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    startActivity(new Intent(GuruActivity.this, LoginActivity.class));
                }
            }
        };
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GuruActivity.this, BuatPengumumanActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.it_setting){
            Intent intent = new Intent(GuruActivity.this, SettingActivity.class);
            startActivity(intent);
